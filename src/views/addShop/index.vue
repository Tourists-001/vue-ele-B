    ...
    <el-row>
      <el-col :span="12" :offset="4">
        ...
        >
          ...
          <el-form-item label="店铺特色" style="white-space: nowrap">
            <span>品牌保证</span>
            <el-switch
              active-text=""
              inactive-text=""
...
import { cityGuess, foodCategory, searchplace, addShop } from "@/api/dataList";
export default {
  data() {
    return {
      city: {},
  ...
  methods: {
      ...
      try {
        ...
        categories.forEach((item, index) => {
          if (item.sub_categories.length) {
            ...
            this.categoryOptions.push(newArr);
    ...
    async querySearchAsync(queryString, cb) {
      queryString = this.formData.address;
      if (queryString) {
        try {
